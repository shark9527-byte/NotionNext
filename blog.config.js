...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '柚子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个拖延症的普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pomelo-blog.netlify.app', // 网站地址
